...
public class AppMensajes {
	...
	public static void main(String[] args) {
		...
		System.out.println(encuentraPatron(listaMensajesInput, "Mensaje 4"));
	}
	...
	// Ejercicio: recibir una List de String y un patron de tipo String
	// y retornar un Boolean indicando si el patron existe en alguno de los
	// textos de la lista. hacer diferencia entre mayusculas y minusculas
	
	public static Boolean encuentraPatron(List<String> listaTextos, String patron) {
		// listaTextos == null
		if(Objects.nonNull(listaTextos) && Objects.nonNull(patron)) {
