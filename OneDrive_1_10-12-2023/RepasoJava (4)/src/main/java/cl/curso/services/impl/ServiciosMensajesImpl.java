...
public class ServiciosMensajesImpl implements IServiciosMensajes {
	...
	private IDatosDummyMensajes repositorio = new DatosDummyMensajesImpl();
	//@Override
	...
	public List<Mensaje> buscarMensajePorTipo(String tipoMensaje){
		...
		return this.repositorio.buscarMensajePorTipo(tipoMensaje);
	}
	...
	public List<Mensaje> todosLosMensajes() {
		...
		return this.repositorio.todosLosMensajes();
	}
	...
	public void modificaMensaje(Integer idMensaje, String textoMensaje) {
		...
		this.repositorio.modificaMensaje(idMensaje, textoMensaje);
	}

	@Override
	public void agregarMensaje(Mensaje nuevoMensaje) {
		// TODO Auto-generated method stub
		this.repositorio.agregarMensaje(nuevoMensaje);
	}

	@Override
	public void eliminarMensaje(Integer idMensaje) {
		// TODO Auto-generated method stub
		this.repositorio.eliminarMensaje(idMensaje);
	}
}
